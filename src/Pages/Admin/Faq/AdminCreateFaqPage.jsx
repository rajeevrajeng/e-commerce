...
export default function AdminCreateFaqPage() {
    ...
    function postData(e) {
        ...
        if (error)
            ...
            dispatch(createFaq({ ...data })) // in not real backend             
            navigate("/admin/faq")
        }
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                <div className="col-12 mb-3">
                                    ...
                                    <input type='text' name='question' placeholder='Question' onChange={getInputData} className={`form-control ${show && errorMessage.question ? 'border-danger' : 'border-primary'} `} />
                                ...
                                <div className="col-12 mb-3">
                                    ...
                                    <textarea  name='answer' rows="3" placeholder='Answer' onChange={getInputData} className={`form-control ${show && errorMessage.answer ? 'border-danger' : 'border-primary'} `}></textarea>
